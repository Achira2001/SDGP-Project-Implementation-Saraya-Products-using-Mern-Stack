    ...
    return (
        <div className="container2">
            <form>
                ...
                <div className="form-group row">
                    <label htmlFor="inputName" className="col-sm-2 col-form-label">N.I.C. Number</label>
                    <div className="col-sm-10">
                        <input type="nic" className="form-control" id="inputId" />
                    </div>
                </div>
                <div className="form-group row">
                    <label htmlFor="inputName" className="col-sm-2 col-form-label">Phone Number</label>
                    <div className="col-sm-10">
                        <input type="tp" className="form-control" id="inputTp_no" />
                    </div>
                </div>
